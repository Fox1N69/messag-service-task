...
**Сервис запущен на IP** - 90.156.218.8:4000 (сервер арендован в самой простой конфигурации из-за нехватки денег. Не стоит ожидать очень хороших результатов, лучше протестировать локально)
